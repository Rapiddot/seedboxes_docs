...
<Button label="Windows" link="https://download.wireguard.com/windows-client/wireguard-installer.exe" icon="fa-brands fa-windows" />
<Button label="MacOS" link="https://itunes.apple.com/us/app/wireguard/id1451685025?ls=1&mt=12" icon="fa-brands fa-apple" />
<Button label="Android" link="https://play.google.com/store/apps/details?id=com.wireguard.android" icon="fa-brands fa-android" />
<Button label="iOS" link="https://itunes.apple.com/us/app/wireguard/id1441195209?ls=1&mt=8" icon="fa-brands fa-apple" />
<Button label="Linux" link="https://www.wireguard.com/install/" icon="fa-brands fa-linux" /><br /><br />
...
Just visit your seedbox at your client area, click the subsection **"VPN"** and then the **"+ Add VPN connection"** button

![vpn.png](https://s3.eu-central-1.amazonaws.com/rapiddot-support-community-uploads/24c69e54-20f2-4e97-9b5b-ca217805171e.png)
...
At the new modal, name the connection to your liking (e.g. macbook) and click the **"Create Connection"** button

![Screenshot 2026-01-18 at 07.32.16.png](https://s3.eu-central-1.amazonaws.com/rapiddot-support-community-uploads/bd47e23e-30d8-4544-941d-8c7a19df96fd.png)

That was it, the connection is generated. You can now download it via the **"Get VPN Configuration"** button

![Screenshot 2026-01-18 at 07.32.36.png](https://s3.eu-central-1.amazonaws.com/rapiddot-support-community-uploads/3131eeb3-fc6d-40e8-8b51-65ea99833fa3.png)
...
![download_vpn_config.png](https://s3.eu-central-1.amazonaws.com/rapiddot-support-community-uploads/8d0414f4-ee2b-41e0-921b-03954d4dca31.png)
...
Either way, click the **"Download Config"** once ready so you can download the file locally.
...
For tablet/mobile devices, you again select the VPN country and server as with Desktop / Laptops (or just use the preselected / default), but now you click the **"Show QRCode"** button instead.
...
![Screenshot 2026-01-18 at 07.32.51.png](https://s3.eu-central-1.amazonaws.com/rapiddot-support-community-uploads/1de6937d-74b9-4ac7-8efa-cd6caad6790d.png)
...
:::note
Try to rename the config file to something that **does not contain spaces and special characters** (like "sbcc" as previously written) or the server location like "France" before importing it, as there is currently a bug with Wireguard and Android mobiles.
:::

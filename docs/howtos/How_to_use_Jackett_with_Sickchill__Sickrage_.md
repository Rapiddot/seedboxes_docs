...
## Installation
Go to your client area, click the **Apps** section and add both applications via **+Install Application** button. You can find a more detailed guide regarding 1-click installation of the apps [here](../howtos/How_to_install_our_1-Click_applications.md)
